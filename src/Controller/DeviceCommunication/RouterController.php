...
use App\DeviceCommunication\RouterCommunication;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;

class RouterController extends AbstractDeviceController
{
    use RouterControllerTrait;

    protected function getDeviceCommunication(): RouterCommunication
    {
        // This should never happen, but testing it to make sure controller doesn't return 500 error
        if (!parent::getDeviceCommunication() instanceof RouterCommunication) {
