...
#[ORM\Entity]
#[MasqueradeValidator(groups: ['device:common'])]
class DeviceMasquerade implements AuditableInterface
{
    ...
    #[ORM\ManyToOne(targetEntity: Device::class, inversedBy: 'masquerades')]
