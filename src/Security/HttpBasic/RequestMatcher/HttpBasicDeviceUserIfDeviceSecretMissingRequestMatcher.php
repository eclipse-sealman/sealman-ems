...
namespace App\Security\HttpBasic\RequestMatcher;
...
class HttpBasicDeviceUserIfDeviceSecretMissingRequestMatcher extends AbstractAuthenticationRequestMatcher
{
    public function isAuthenticationMethodValid(DeviceType $deviceType, ?bool $isFirmwareSecured = null): bool
    {
        ...
        if (AuthenticationMethod::BASIC == $deviceType->getAuthenticationMethod()) {
            if (CredentialsSource::USER_IF_SECRET_MISSING == $deviceType->getCredentialsSource()) {
                return true;
            }
        }
