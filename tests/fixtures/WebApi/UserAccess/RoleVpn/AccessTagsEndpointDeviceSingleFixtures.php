...
class AccessTagsEndpointDeviceSingleFixtures extends AbstractFixtureGroupAsClass implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $endpointDevice = $this->createEndpointDevice($manager, $device, 'ed');
