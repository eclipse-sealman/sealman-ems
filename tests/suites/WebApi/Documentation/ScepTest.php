...
class ScepTest extends AbstractDocumentationTest
{
    ...
    public static function getData(): array
    {
        return [
            ...
            ['/web/doc/vpnsecuritysuite', 404],
            ['/web/doc/vpnsecuritysuite.yaml', 404],
            ['/web/doc/smartemsvpnsecuritysuite', 404],
            ['/web/doc/smartemsvpnsecuritysuite.yaml', 404],
        ];
    }
}
