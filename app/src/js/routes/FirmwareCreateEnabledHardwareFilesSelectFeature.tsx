...
const FirmwareCreateEnabledHardwareFilesSelectFeature = () => {
    ...
    React.useEffect(() => {
        ...
        if (tiles.length === 1) {
            navigate("/firmware/create/enabledhardwarefiles/" + deviceTypeId + "/" + tiles[0].id, { replace: true });
            return;
        }
                ...
                renderTile: (option) => (
                    <Tile
                        ...
                        {...{
                            ...
                            to: "/firmware/create/enabledhardwarefiles/" + deviceTypeId + "/" + option.id,
                            icon: <MemoryOutlined />,
                        }}
                    />
                ),
...
export default FirmwareCreateEnabledHardwareFilesSelectFeature;
