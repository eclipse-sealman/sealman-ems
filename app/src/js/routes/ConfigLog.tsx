...
import getFilters from "~app/entities/ConfigLog/filters";
        ...
        <Builder
            {...{
                ...
                listProps: {
                    ...
                    visibleColumnsKey: "configLog",
                    defaultColumns: ["logLevel", "device", "featureName", "createdAt", "updatedAt", "actions"],
                },
                deleteProps: {},
                duplicateProps: {},
            }}
