...
interface BatchUsersCertificateAutomaticBehaviorCollectionProps
    extends Omit<CertificateTypeCollectionProps, "fields" | "certificateTypes"> {
    enable: boolean;
}

const BatchUsersCertificateAutomaticBehaviorCollection = ({
    enable,
    ...certificateTypeCollectionProps
}: BatchUsersCertificateAutomaticBehaviorCollectionProps) => {
            ...
            (certificateType: CertificateTypeInterface, index: number | string) => {
                ...
                if (enable) {
                    ...
                    if (certificateType.enabledBehaviour == "specific") {
                        //For now only technicianVpn has specific behavior (for devices)
                        if (certificateType.certificateCategory == "technicianVpn") {
...
export default BatchUsersCertificateAutomaticBehaviorCollection;
export { BatchUsersCertificateAutomaticBehaviorCollectionProps };
