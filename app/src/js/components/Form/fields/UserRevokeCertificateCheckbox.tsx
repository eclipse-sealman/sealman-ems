...
interface UserRevokeCertificateCheckboxProps extends CheckboxProps {
    enabledPath?: string;
...
const UserRevokeCertificateCheckbox = ({
    enabledPath = "enabled",
    roleAdminPath = "roleAdmin",
    roleSmartemsPath = "roleSmartems",
    roleVpnPath = "roleVpn",
    ...checkboxProps
}: UserRevokeCertificateCheckboxProps) => {
    ...
    const update = () => {
        ...
        if (roleVpn) {
            setFieldValue("revokeCertificate", !enabled);
        } else if (roleSmartems) {
            setFieldValue("revokeCertificate", false);
        }
    };
...
export default UserRevokeCertificateCheckbox;
export { UserRevokeCertificateCheckboxProps };
