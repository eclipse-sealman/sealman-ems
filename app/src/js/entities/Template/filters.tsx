...
import { DateTimeFromFilter, DateTimeToFilter, getFields, SelectApiFilter, TextFilter } from "@arteneo/forge";
import MultiselectDeviceTypeFilter from "~app/components/Table/filters/MultiselectDeviceTypeFilter";

const filters = {
    deviceType: <MultiselectDeviceTypeFilter {...{ endpoint: "/options/template/device/types" }} />,
    name: <TextFilter />,
