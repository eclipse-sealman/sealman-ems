...
import BatchUsersCertificateAutomaticBehaviorCollection from "~app/components/Form/fields/BatchUsersCertificateAutomaticBehaviorCollection";
...
type BatchEnableProps = Optional<BatchFormMultiAlertProps, "dialogProps">;
...
const BatchEnable = (props: BatchEnableProps) => {
    ...
    if (isAccessGranted({ adminScep: true }) && useableCertificateTypes !== undefined) {
        fields = {
            certificateBehaviours: <BatchUsersCertificateAutomaticBehaviorCollection {...{ enable: true }} />,
        };
    }
    ...
    return (
        <BatchFormMultiAlert
            {...{
                label: "batch.user.enable.action",
                ...props,
                dialogProps: {
                    title: "batch.user.enable.title",
                    label: hasUseableCertificateTypes()
                        ? "batch.user.enable.labelWithGenerate"
                        : "batch.user.enable.label",
                    formProps: {
