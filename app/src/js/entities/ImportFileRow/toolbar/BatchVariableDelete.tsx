...
const BatchVariableDelete = (props: BatchVariableDeleteProps) => {
    return (
        <BatchFormAlert
            {...{
                label: "batch.importFileRow.variableDelete.action",
                ...props,
                dialogProps: {
                    title: "batch.importFileRow.variableDelete.title",
                    label: "batch.importFileRow.variableDelete.label",
                    formProps: {
                        fields: {
                            name: <Text {...{ required: true }} />,
                        },
                        endpoint: "/importfilerow/batch/variable/delete",
                    },
                    ...props.dialogProps,
                },
            }}
