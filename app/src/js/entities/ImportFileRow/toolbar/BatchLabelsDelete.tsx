...
const BatchLabelsDelete = (props: BatchLabelsDeleteProps) => {
    return (
        <BatchFormAlert
            {...{
                label: "batch.importFileRow.labelsDelete.action",
                ...props,
                dialogProps: {
                    title: "batch.importFileRow.labelsDelete.title",
                    label: "batch.importFileRow.labelsDelete.label",
                    formProps: {
                        fields: {
                            labels: <MultiselectApi {...{ required: true, endpoint: "/options/labels" }} />,
                        },
                        endpoint: "/importfilerow/batch/labels/delete",
                    },
                    ...props.dialogProps,
                },
            }}
