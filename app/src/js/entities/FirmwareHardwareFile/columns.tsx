...
import FirmwareHardwareFileEdit from "~app/entities/FirmwareHardwareFile/actions/FirmwareHardwareFileEdit";

const columns = {
    hardware: <RepresentationColumn />,
    sourceType: <FirmwareSourceTypeColumn />,
    filename: <TextColumn />,
    md5: <TextSqueezedCopyColumn />,
    uuid: <TextSqueezedCopyColumn path="firmware.uuid" />,
